...
class TestSensor(unittest.TestCase):
    def test_Scene1_1(self):
        ...
        sensor = Sensor(scene)
        expected = {
            "NORTH": {"count": 1, "uids": ["d7ae1052"]},
            "WEST": {
                "count": 4,
                "uids": ["d392f87d", "fb7d643b", "539d89b3", "1a6d7a61"],
            },
            "EAST": {"count": 3, "uids": ["a0538bb7", "2d1d9350", "cde2cc25"]},
            "SOUTH": {"count": 2, "uids": ["e512e853", "bdc94d23"]},
            "ALL": {"count": 40},
        }
        data = sensor.getData()
    ...
    def test_Scene5_1(self):
        ...
        sensor = Sensor(scene=scene, vehicle_counts=sceneDynamic)
        expected = {
            "NORTH": {
                "count": 0,
                "uids": [
